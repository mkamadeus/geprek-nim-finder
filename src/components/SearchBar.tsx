...
const SearchBar: React.FC<Props> = (props: Props) => {
  ...
  return (
    <>
      <form className="flex rounded-full shadow p-2 mb-1 w-full border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-700 active:border-teal-200">
        <input
          value={keywords}
          onChange={onSearch}
